...
/**
 * This class is responsible for the actual compilation of Bramspr programs. Intended to be used in conjunction with {@link bramspr.BramsprLexer},
 * {@link bramspr.BramsprParser} and {@link bramspr.BramsprChecker}.
 * 
 * The code generation starts with feeding a parse tree + parse tree decoration as generated by {@link bramspr.BramsprParser} and {@link bramspr.BramsprChecker}
 * to {@link #compile}. The program then gets translated to Java bytecode by recursive calls to various visit-methods this class contains.
 * 
 */
public class BramsprCompiler extends BramsprBaseVisitor<Symbol> implements Opcodes {
	 ...
	 * 
	 * @param assignable
	 *            what (variable or variable field) we are assigning to
	 * @param assignableType
	 *            what type we are assigning to it (INTEGER, STRING, PERSON, etc.)
	 */
	 ...
	 * Puts one value on the stack: either the value of the field or a reference to the object the field belongs to (depending on the value of
	 * {@link #inReadAccessToField})
	 */
	@Override

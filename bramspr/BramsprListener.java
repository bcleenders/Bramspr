...
public interface BramsprListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link BramsprParser#primitiveType}.
	 * @param ctx the parse tree
	 */
	void enterPrimitiveType(@NotNull BramsprParser.PrimitiveTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link BramsprParser#primitiveType}.
	 * @param ctx the parse tree
	 */
	void exitPrimitiveType(@NotNull BramsprParser.PrimitiveTypeContext ctx);
